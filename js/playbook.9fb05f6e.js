!(function () {
  ...
  var j = R,
    ...
    z_hasWheelEvent = "onwheel" in document,
    z_hasMouseWheelEvent = "onmousewheel" in document,
    z_hasTouch =
    ...
    z_hasPointer = !!window.navigator.msPointerEnabled,
    z_hasKeyDown = "onkeydown" in document,
    z_isFirefox = navigator.userAgent.indexOf("Firefox") > -1,
  ...
  ($.prototype._notify = function (t) {
    ...
    ($.prototype._onMouseWheel = function (t) {
    ...
    ($.prototype._onTouchStart = function (t) {
      var e = t.targetTouches ? t.targetTouches[0] : t;
      (this.touchStartX = e.pageX), (this.touchStartY = e.pageY);
    }),
    ($.prototype._onTouchMove = function (t) {
      var e = this.options;
      e.preventTouch &&
    ...
    ($.prototype._onKeyDown = function (t) {
      var e = this._event;
      e.deltaX = e.deltaY = 0;
    ...
    ($.prototype._unbind = function () {
      z_hasWheelEvent && this.el.removeEventListener("wheel", this._onWheel),
        z_hasMouseWheelEvent &&
  ...
  var ut = function (t, e, i, r) {
      ...
      for (
        ...
        n[s] = ot(0.1 * s, t, i);
      function o(e) {
        for (var r = 0, s = 1; 10 !== s && n[s] <= e; ++s) r += 0.1;
        --s;
        var o = r + ((e - n[s]) / (n[s + 1] - n[s])) * 0.1,
          a = at(o, t, i);
        return a >= 0.001
          ? (function (t, e, i, r) {
              for (var n = 0; n < 4; ++n) {
                    ...
                    var r,
                      ...
                      v = (s =
                        void 0 !== y
                          ...
                          : e).getBoundingClientRect();
                    null === a || a.inView
                      ? ((r = v.top + t.instance.scroll.y - J(s).y),
                        (n = v.left + t.instance.scroll.x - J(s).x))
                      : ((r = v.top - J(a.el).y - J(s).y),
                        (n = v.left - J(a.el).x - J(s).x));
              ...
              !(function t() {
                ...
                i > 1
                  ? (y(1),
                    ...
                    0 == n && e.update(),
                    a && a())
                  : ((e.scrollToRaf = requestAnimationFrame(t)), y(s(i)));
              })();
            },
          },
          {
            ...
            value: function () {
              if (
                ...
                (this.smartphone.smooth &&
                  this.options.isMobile &&
                  !this.options.isTablet)
                  ? (this.scroll = new yt(this.options))
  ...
  (Tt.prototype.getOrigin = function (t) {
    var e = t.match(/(https?:\/\/[\w\-.]+)/);
    return e ? e[1].replace(/https?:\/\//, "") : null;
  }),
    (Tt.prototype.getPathname = function (t) {
      var e = t.match(/https?:\/\/.*?(\/[\w_\-./]+)/);
      return e ? e[1] : "/";
    }),
    (Tt.prototype.getAnchor = function (t) {
      var e = t.match(/(#.*)$/);
      return e ? e[1] : null;
    }),
    (Tt.prototype.getParams = function (t) {
      var e = t.match(/\?([\w_\-.=&]+)/);
      if (!e) return null;
    ...
    (Tt.prototype.getDOM = function (t) {
      return "string" == typeof t ? Et.parseFromString(t, "text/html") : t;
    }),
    (Tt.prototype.getView = function (t) {
      return t.querySelector("[data-router-view]");
    }),
    (Tt.prototype.getSlug = function (t) {
      return t.getAttribute("data-router-view");
    }),
    (Tt.prototype.getRenderer = function (t) {
    ...
    (Tt.prototype.getTransition = function (t) {
    ...
    (Tt.prototype.getProperties = function (t) {
      var e = this.getDOM(t),
        i = this.getView(e),
        r = this.getSlug(i);
      return {
    ...
    (Tt.prototype.getLocation = function (t) {
      return {
        href: t,
  ...
  var At = { Core: Ft, Helpers: Tt, Renderer: Ct, Transition: St };
  function kt(t) {
    if (void 0 === t)
      throw new ReferenceError(
        "this hasn't been initialised - super() hasn't been called"
  ...
  var Mt,
    ...
    Qe = function (t, e, i) {
      return (i = t[e]) && me(i)
        ? t[e]()
        : (ve(i) && t.getAttribute && t.getAttribute(e)) || i;
    },
    $e = function (t, e) {
    ...
    Ti = function (t, e, i, r) {
      ...
      return (
        ...
        o && !r ? _i(t, (t._tTime = t._tDur * o)) : t.parent && vi(t),
        i || fi(t.parent, t),
        t
      );
    },
    Fi = function (t) {
      return t instanceof yr ? fi(t) : Ti(t, t._dur);
    },
    ...
    Vi = function (t) {
      for (var e, i, r, n, s = 0, o = ""; ~(e = t.indexOf("random(", s)); )
        (r = t.indexOf(")", e)),
          (n = "[" === t.charAt(e + 7)),
          (i = t.substr(e + 7, r - e - 7).match(n ? Oe : Te)),
          (o +=
            t.substr(s, e - s) +
    ...
    $i = function (t, e, i) {
      var r,
        ...
        h,
        d,
        f = t ? (ye(t) ? [t >> 16, (t >> 8) & Ui, t & Ui] : 0) : Ki.black;
      if (!f) {
        if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Ki[t]))
          ...
          if (((f = d = t.match(Te)), e)) {
            if (~t.indexOf("="))
              return (f = t.match(Fe)), i && f.length < 4 && (f[3] = 1), f;
          } else
            (o = (+f[0] % 360) / 360),
              (a = +f[1] / 100),
              (r =
              ...
              (f[1] = Qi(o, r, n)),
              (f[2] = Qi(o - 1 / 3, r, n));
        else f = t.match(Te) || Ki.transparent;
        f = f.map(Number);
      }
      return (
        e &&
    ...
    dr(
      ...
      (se = function (t) {
        return t < ne
          ...
          ? ie * Math.pow(t - 1.5 / 2.75, 2) + 0.75
          : t < 0.9090909090909092
          ? ie * (t -= 2.25 / 2.75) * t + 0.9375
          : ie * Math.pow(t - 2.625 / 2.75, 2) + 0.984375;
      })
    ),
    dr("Expo", function (t) {
    ...
    mr = (function () {
      ...
      return (
        ...
        (e.timeScale = function (t) {
          ...
          var e =
            this.parent && this._ts ? yi(this.parent._time, this) : this._tTime;
          return (
            (this._rts = +t || 0),
            ...
            (function (t) {
              ...
              return t;
            })(this.totalTime(Oi(-this._delay, this._tDur, e), !0))
          );
        }),
        (e.paused = function (t) {
          return arguments.length
        ...
        (e.repeat = function (t) {
          return arguments.length
            ? ((this._repeat = t === 1 / 0 ? -2 : t), Fi(this))
            : -2 === this._repeat
            ? 1 / 0
            : this._repeat;
        }),
  ...
  var yr = (function (t) {
    ...
    return (
      (i.to = function (t, e, i) {
        return (
          new Fr(t, ti(arguments, 0, this), Ai(this, ye(e) ? arguments[3] : i)),
          this
        );
      }),
      (i.from = function (t, e, i) {
        return (
          new Fr(t, ti(arguments, 1, this), Ai(this, ye(e) ? arguments[3] : i)),
          this
        );
      }),
      (i.fromTo = function (t, e, i, r) {
        return (
          new Fr(t, ti(arguments, 2, this), Ai(this, ye(e) ? arguments[4] : r)),
          this
        );
      }),
      (i.set = function (t, e, i) {
        return (
          ...
          new Fr(t, e, Ai(this, i), 1),
          this
        );
      }),
      (i.call = function (t, e, i) {
        return bi(this, Fr.delayedCall(0, t, e), Ai(this, i));
      }),
      ...
      (i.render = function (t, e, i) {
        var r,
          ...
          m = this._dur,
          y = this !== Bt && t > g - ue && t >= 0 ? g : t < ue ? 0 : t,
        ...
        if (y !== this._tTime || i || v) {
          ...
          if (
            ...
            return (this._start = h), vi(this), this.render(t, e, i);
          this._onUpdate && !e && Yi(this, "onUpdate", !0),
            ((y === g && g >= this.totalDuration()) || (!y && D)) &&
              ((h !== this._start && Math.abs(c) === Math.abs(this._ts)) ||
                ...
                e ||
                  (t < 0 && !D) ||
                  (!y && !D) ||
                  (Yi(this, y === g ? "onComplete" : "onReverseComplete", !0),
                  this._prom &&
      ...
      (i.add = function (t, e) {
        var i = this;
        if ((ye(e) || (e = Ai(this, e)), !(t instanceof mr))) {
          if (Ee(t))
            return (
              t.forEach(function (t) {
                return i.add(t, e);
      ...
      (i.getTweensOf = function (t, e) {
        for (var i, r = [], n = Pi(t), s = this._first, o = ye(e); s; )
          s instanceof Fr
            ? Je(s._targets, n) &&
              (o
                ? (!vr || (s._initted && s._ts)) &&
            ...
            si(
              {
                ...
                onStart: function () {
                  ...
                  u._dur !== t && Ti(u, t, 0, 1).render(u._time, !0, !0),
                    o && o.apply(u, a || []);
                },
              },
              e
        ...
        if (s._dirty) {
          for (r = s.parent; o; )
            (e = o._prev),
              ...
              (o = e);
          Ti(s, s === Bt && s._time > n ? s._time : n, 1, 1), (s._dirty = 0);
        }
        return s._tDur;
      }),
      (e.updateRoot = function (t) {
        if ((Bt._ts && (ii(Bt, yi(t, Bt)), (qt = rr.frame)), rr.frame >= Ye)) {
          Ye += oe.autoSleep || 120;
          var e = Bt._first;
  ...
  si(yr.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
  var vr,
    ...
    Tr = (Er + ",id,stagger,delay,duration,paused,scrollTrigger").split(","),
    Fr = (function (t) {
      function e(e, i, r, n) {
        var s;
        ...
        var o,
          ...
          x = p.yoyoEase,
          C = s.parent,
          E = (Ee(e) || Ce(e) ? ye(e[0]) : "length" in i) ? [e] : Pi(e);
        if (
          ((s._targets = E.length
            ? Ue(E)
            : je(
          ...
          if (
            ((i = s.vars),
            (o = s.timeline =
              new yr({ data: "nested", defaults: w || {} })).kill(),
            (o.parent = o._dp = kt(s)),
            (o._start = 0),
            _)
          )
            ...
            if (((u = E.length), (d = y ? ji(y) : ze), _e(y)))
              for (c in y) ~Er.indexOf(c) && (f || (f = {}), (f[c] = y[c]));
            for (a = 0; a < u; a++) {
              for (c in ((l = {}), i)) Tr.indexOf(c) < 0 && (l[c] = i[c]);
              (l.stagger = 0),
                x && (l.yoyoEase = x),
                f && ai(l, f),
                (h = E[a]),
        ...
        return (
          !0 !== v || Mt || ((vr = kt(s)), Bt.killTweensOf(E), (vr = 0)),
          C && wi(C, kt(s)),
          (m ||
            (!D &&
              !_ &&
      ...
      return (
        ...
        (i.kill = function (t, e) {
          ...
          if (this.timeline) {
            ...
            return (
              this.timeline.killTweensOf(t, e, vr && !0 !== vr.vars.overwrite)
                ._first || Xi(this),
              this.parent &&
                i !== this.timeline.totalDuration() &&
                Ti(this, (this._dur * this.timeline._tDur) / i, 0, 1),
              this
            );
          }
          var r,
  ...
  si(Fr.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 }),
  ...
  var Sr = function (t, e, i) {
    ...
    Mr = function (t, e) {
      return me(t[e]) ? Ar : ve(t[e]) && t.setAttribute ? Or : Sr;
    },
    Br = function (t, e) {
  ...
  $e(
    ...
    (Be.TweenMax = Be.TweenLite = Fr),
    (Be.TimelineLite = Be.TimelineMax = yr),
    (Bt = new yr({
      sortChildren: !1,
      defaults: ae,
  ...
  (Fr.version = yr.version = Yr.version = "3.6.1"),
    (jt = 1),
    be() && nr(),
    sr.Power0,
    sr.Power1,
  ...
  var Xr,
    ...
    Rn = function (t, e, i, r) {
      ...
      var o,
        ...
        g,
        m,
        y = new Hr(this._pt, t.style, e, 0, 1, Pr),
        v = 0,
        _ = 0;
      if (
        ((y.b = i),
        ...
        for (; (a = Se.exec(r)); )
          (d = a[0]),
            ...
            d !== (h = l[_++] || "") &&
              ...
              (f = parseFloat(d)),
              (D = d.substr((f + "").length)),
              (v = Se.lastIndex - D.length),
              D ||
                ((D = D || oe.units[e] || g),
                v === r.length && ((r += D), (y.e += D))),
              g !== D && (u = Ln(t, e, h, D) || 0),
              (y._pt = {
                _next: y._pt,
                p: p || 1 === _ ? p : ",",
      ...
      } else y.r = "display" === e && "none" === r ? fn : dn;
      return ke.test(r) && (y.e = 0), (this._pt = y), y;
    },
    jn = {
      top: "0%",
      bottom: "100%",
    ...
    Wn = function (t) {
      var e = xn(t, _n);
      return Vn(e) ? In : e.substr(7).match(Fe).map(Ze);
    },
    Nn = function (t, e) {
      var i,
        r,
    ...
    Yn = function (t, e, i, r, n, s) {
      ...
      i
        ? c !== In &&
          (a = D * y - g * m) &&
          ((l = b * (-g / a) + x * (D / a) - (D * _ - g * v) / a),
          (b = b * (y / a) + x * (-m / a) + (m * _ - y * v) / a),
          (x = l))
        ...
        r || (!1 !== r && u.smooth)
          ? ((v = b - h),
            (_ = x - d),
            (u.xOffset = f + (v * D + _ * m) - v),
            (u.yOffset = p + (v * g + _ * y) - _))
    ...
    Xn = function (t, e) {
      ...
      return (
        ...
        (g = Nn(t, i.svg)),
        i.svg &&
          ((T = !i.uncache && !e && t.getAttribute("data-svg-origin")),
          Yn(t, T || z, !!T || i.originIsAbsolute, !1 !== i.smooth, g)),
        (p = i.xOrigin || 0),
        (D = i.yOrigin || 0),
        g !== In &&
          ((_ = g[0]),
          ...
          6 === g.length
            ...
            : ((L = g[6]),
              ...
              (u = (m = rn(L, O)) * tn),
              m &&
                ((T = C * (y = Math.cos(-m)) + A * (v = Math.sin(-m))),
                (F = E * y + k * v),
                (S = L * y + O * v),
                (A = C * -v + A * y),
                (k = E * -v + k * y),
              ...
              m &&
                ((y = Math.cos(-m)),
                (B = x * (v = Math.sin(-m)) + B * y),
                (_ = T = _ * y - A * v),
                (w = F = w * y - k * v),
                (b = S = b * y - O * v)),
              (l = (m = rn(w, _)) * tn),
              m &&
                ((T = _ * (y = Math.cos(m)) + w * (v = Math.sin(m))),
                (F = C * y + E * v),
                (w = w * y - _ * v),
                (E = E * y - C * v),
                (_ = T),
    ...
    Jn = function (t, e) {
      ...
      if (y && (c !== Qn || u !== Qn)) {
        ...
        (b = parseFloat(c) * en),
          (w = Math.cos(b)),
          (s = Un(m, s, x * w * -y)),
          (o = Un(m, o, -Math.sin(b) * -y)),
          (a = Un(m, a, C * w * -y + y));
      }
      D !== $n && (v += "perspective(" + D + Zn),
        (r || n) && (v += "translate(" + r + "%, " + n + "%) "),
        (_ || s !== $n || o !== $n || a !== $n) &&
          (v +=
            a !== $n || _
        ...
        u !== Qn && (v += "rotateY(" + u + Zn),
        c !== Qn && (v += "rotateX(" + c + Zn),
        (h === Qn && d === Qn) || (v += "skew(" + h + ", " + d + Zn),
        (1 === f && 1 === p) || (v += "scale(" + f + ", " + p + Zn),
        (m.style[_n] = v || "translate(0, 0)");
    },
    ts = function (t, e) {
      var i,
        r,
          ...
          if (
            ...
            if (
              ...
              if (
                (T && h in T
                  ? ((s =
                      "function" == typeof T[h] ? T[h].call(i, r, t, n) : T[h]),
  ...
  (Yr.utils.checkPrefix = En),
    ...
    (an[os[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + ss),
    $e(
  ...
  var vs,
    ...
    bs = function () {
      (vs = ws())
        ? (vs.registerEase("_CE", Fs.create), (_s = 1))
    ...
    Ts = function t(e, i, r, n, s, o, a, l, u, c, h) {
      var d,
        f = (e + r) / 2,
        p = (i + n) / 2,
        D = (r + s) / 2,
      ...
      return (
        ...
        (F + S) * (F + S) > u * (E * E + T * T) &&
          ((d = c.length),
          t(e, i, f, p, v, _, x, C, u, c, h),
          t(x, C, w, b, m, y, a, l, u, c, h + 1 + (c.length - d))),
        c
      );
    },
    Fs = (function () {
      ...
      return (
        (e.setData = function (t, e) {
                ...
                for (e = 0; e < w; e++)
                  if (
                    ...
                    (c = y + (r - y) * _),
                      ...
                      (y += 1 * g[e + 3]),
                      (v += 1 * g[e + 4]),
                      a.push(c, h, y + (r - y) * _, v + (n - v) * _, y, v),
                      (e += 4);
                  else if ("T" === s)
                    (c = y - a[a.length - 4]),
                      (h = v - a[a.length - 3]),
                      ...
                      (e += 2);
                  else if ("H" === s) C(y, v, (y = r), v), (e += 1);
                  else if ("V" === s)
                    C(y, v, y, (v = r + (o ? v - y : 0))), (e += 1);
                  else if ("L" === s || "Z" === s)
                    "Z" === s && ((r = l), (n = u), (a.closed = !0)),
                      ("L" === s || ps(y - r) > 0.5 || ps(v - n) > 0.5) &&
                        (C(y, v, r, n), "L" === s && (e += 2)),
                      (y = r),
                      (v = n);
                  else if ("A" === s) {
          ...
          return (
            ...
            this.id && vs.registerEase(this.id, this.ease),
            this
          );
        }),
        ...
        (t.getSVGData = function (e, i) {
          var r,
            ...
            D = i.x || 0,
            g = (i.y || 0) + p,
            m = vs.utils.toArray(i.path)[0];
          if (
            (i.invert && ((p = -p), (g = 0)),
            "string" == typeof e && (e = vs.parseEase(e)),
            e.custom && (e = e.custom),
            e instanceof t)
          )
            r = (function (t) {
  ...
  ws() && vs.registerPlugin(Fs), (Fs.version = "3.6.1"), ls.registerPlugin(Fs);
  let Ss = Fs.create(
    "smooth",
  ...
  class Qs extends At.Transition {
    in({ from: t, to: e, trigger: i, done: r }) {
      ls.timeline({ defaults: { ease: Ss } })
  ...
  var Js,
    ...
    mo = function (t, e, i, r, n, s, o) {
      var a,
        ...
        _ = go("paddingLeft", v),
        w = -999,
        b = go("borderBottomWidth", v) + go("borderTopWidth", v),
        x = go("borderLeftWidth", v) + go("borderRightWidth", v),
        C = go("paddingTop", v) + go("paddingBottom", v),
        E = go("paddingLeft", v) + go("paddingRight", v),
        T = 0.2 * go("fontSize", v),
        F = v.textAlign,
        S = [],
        A = [],
              ...
              !P && R
                ? c._isSplit
                  ...
                  ? ((c._parent = c.parentNode),
                    ...
                    u--)
                  : d ||
                    ((y = !c.nextSibling && po(c.parentNode, t, O)),
                    c.parentNode._parent && c.parentNode._parent.appendChild(c),
                    y && c.parentNode.appendChild(Js.createTextNode(" ")),
        ...
        for (p = " " === O && (!j || (!P && !R)), a = 0; a < L.length; a++) {
          for (
            ...
            "BR" !== f[l].nodeName &&
              ...
              j &&
                (0 === l &&
                  ((g.style.top = c._y + "px"), (g.style.left = _ + y + "px")),
                (c.style.top = "0px"),
    ...
    yo = function (t, e, i, r) {
      ...
      for (
        ...
        if (((u = n.charAt(o)), v && (h = v(n.substr(o), e.specialChars))))
          ...
          for (s += y ? m : "", y = 0; n.charAt(o + 1) === D; ) (s += g), o++;
          o === l - 1
            ? (s += g)
            : ")" !== n.charAt(o + 1) && ((s += g + i()), (y = 1));
        } else
          "{" === u && "{{LT}}" === n.substr(o, 6)
            ? ((s += f ? r() + "{{LT}}</" + d + ">" : "{{LT}}"), (o += 5))
            : (u.charCodeAt(0) >= 55296 && u.charCodeAt(0) <= 56319) ||
              (n.charCodeAt(o + 1) >= 65024 && n.charCodeAt(o + 1) <= 65039)
            ? ((a = ((n.substr(o, 12).split($s) || [])[1] || "").length || 2),
              (s +=
                f && " " !== u
                  ? r() + n.substr(o, a) + "</" + d + ">"
                  : n.substr(o, a)),
  ...
  var Wo,
    ...
    ml = function (t, e, i, r, n, s, o) {
      ...
      return (
        (y += "position:" + (p && f ? "fixed;" : "absolute;")),
        (p || !f) &&
          (y += (r === nl ? Na : Ya) + ":" + (s + parseFloat(c)) + "px;"),
        o &&
          (y +=
    ...
    bl = function () {
      Zo || ((Zo = $o(Rl)), wa || Al("scrollStart"), (wa = va()));
    },
    xl = function () {
      return !ra && !da && !Xo.fullscreenElement && Qo.restart(!0);
    },
    Cl = {},
    El = [],
    Tl = [],
    Fl = function (t) {
      var e,
        ...
        n = 0;
      if (Da !== i || ga) {
        for (Ml(); n < Tl.length; n += 4)
          (e = Yo.matchMedia(Tl[n]).matches) !== Tl[n + 3] &&
            ((Tl[n + 3] = e),
            e ? r.push(n) : Ml(1, Tl[n]) || (La(Tl[n + 2]) && Tl[n + 2]()));
        for (Ol(), n = 0; n < r.length; n++)
          (e = r[n]), (pa = Tl[e]), (Tl[e + 2] = Tl[e + 1](t));
    ...
    Bl = function (t, e) {
      if (!wa || t) {
        ...
        for (ca && Ul.sort(), e || Ml(), oa = 0; oa < vl.length; oa++)
          vl[oa].refresh();
        for (
    ...
    Rl = function () {
      ...
      if (
        ...
        for (oa = t; oa-- > 0; ) vl[oa] && vl[oa].update(0, i);
        Pl = 1;
      } else for (oa = 0; oa < t; oa++) vl[oa] && vl[oa].update(0, i);
      Zo = 0;
    },
    jl = [
      "left",
    ...
    Nl = function (t, e, i, r, n, s, o, a, l, u, c, h) {
      if (
        ...
        (g && (g.left || g.top)) ||
          ...
          o && yl(o, f, r, i - f < 20 || (o._isStart && f > 20)),
          (i -= i - f);
      }
      if (s) {
        var y = t + i,
        ...
        (h = "scroll" + r.d2),
          yl(
            ...
            r,
            (v && y > 20) ||
              (!v && (c ? Math.max(Uo[h], Go[h]) : s.parentNode[h]) <= y + 1)
          ),
          c &&
            ((l = al(o)),
      ...
      (t.prototype.init = function (e, i) {
        if (((this.progress = this.start = 0), this.vars && this.kill(1), ba)) {
          ...
          (Dt.media = pa),
            ...
            (Q = Dt.trigger = Jo(Q || $)[0]),
            ($ = !0 === $ ? Q : Jo($)[0]),
            Ba(Y) && (Y = { targets: Q, className: Y }),
            $ &&
              (!1 === Z ||
                "margin" === Z ||
                (Z = !(!Z && "flex" === sl($.parentNode).display) && Za),
              (Dt.pin = $),
              !1 !== e.force3D && Wo.set($, { force3D: !0 }),
              (n = Wo.core.getCache($)).spacer
                ? (m = n.pinState)
              ...
              e !== o &&
                ...
                $ &&
                  (e
                    ...
                    : (!st || !Dt.isActive) && zl($, _, sl($), F)),
                (o = e));
            }),
            (Dt.refresh = function (r, n) {
              if ((!ra && Dt.enabled) || n)
                if ($ && r && wa) hl(t, "scrollEnd", Sl);
                else {
                  (ra = 1),
                    B && B.pause(),
                  ...
                  for (
                    var s,
                      ...
                      Y = (Q && Math.max(0, vl.indexOf(Dt))) || 0,
                      X = Y;
                    X--;

                  )
                    (S = vl[X]).end || S.refresh(0, 1) || (ra = 1),
                      (A = S.pin) && (A === Q || A === $) && S.revert();
                  for (
                    u =
                      Nl(N, Q, M, V, Dt.scroll(), h, f, Dt, L, pt, ct, P) ||
                      ($ ? -0.001 : 0),
                      La(H) && (H = H(Dt)),
                      Ba(H) &&
                        !H.indexOf("+=") &&
                  ...
                  if (
                    ...
                    (s = sl($)),
                      ...
                      ct &&
                        ...
                        (T.height = T.maxHeight = Math.ceil(D.height) + il),
                        (T.margin =
                          T.marginTop =
                          T.marginRight =
                          T.marginBottom =
                      ...
                      i
                        ? ((O = i._initted),
                          ...
                          i.progress(1, !0),
                          (E = b(V.a) - C + g + I),
                          g !== E && y.splice(y.length - 2, 2),
                          i.progress(0, !0),
                          O || i.invalidate(),
                          ha(0))
                        : (E = g);
                  else if (Q && Dt.scroll())
                    for (D = Q.parentNode; D && D !== Uo; )
                      D._pinOffset &&
                        ((u -= D._pinOffset), (c -= D._pinOffset)),
                        (D = D.parentNode);
                  for (X = 0; X < Y; X++)
                    (S = vl[X].pin) && (S === Q || S === $) && vl[X].revert(!1);
                  (Dt.start = u),
                    (Dt.end = c),
                    ...
                    j !== Dt.progress &&
                      ...
                      (Dt.progress = j),
                      Dt.update()),
                    $ && Z && (_._pinOffset = Math.round(Dt.progress * E)),
                    U && U(Dt);
                }
            }),
            (Dt.getVelocity = function () {
              return ((Dt.scroll() - l) / (va() - ea)) * 1e3 || 0;
            }),
            ...
            (Dt.disable = function (e, i) {
              if (
                ...
                for (var s = vl.length; s--; )
                  if (vl[s].scroller === at && vl[s] !== Dt) return;
      ...
      (t.register = function (e) {
        if (
          ...
          (r.borderTop = "1px solid #000"),
            ...
            ql.push(sa),
            (No = va()),
            (Qo = Wo.delayedCall(0.2, Bl).pause()),
            (ua = [
              Xo,
              "visibilitychange",
              function () {
              ...
              : (e = Yo.matchMedia(i)) &&
                ...
                ~r
                  ...
                  : ((r = Tl.length),
                    ...
                    e.addListener
                      ? e.addListener(Fl)
                      : e.addEventListener("change", Fl)),
                (Tl[r + 3] = e.matches)),
            (pa = 0);
        return Tl;
      }),
      (t.clearMatchMedia = function (t) {
        t || (Tl.length = 0), (t = Tl.indexOf(t)) >= 0 && Tl.splice(t, 4);
      }),
      t
    );
  })();
  ...
  class Kl extends At.Renderer {
    onEnter() {
      ...
      Ul.create({
        ...
        Ul.refresh();
      var r = ["#C1C6D7", "#FF99A8", "#DBCABD", "#FFBC99", "#E5B5B3"];
  ...
  new At.Core({
    renderers: { home: Kl, play: Ql },
    transitions: { home: Ks, play: Qs },
  }).on("NAVIGATE_END", () => {
    _t.start(), _t.update();
  }),
  ...
  const $l = document.querySelectorAll("#js-slider > div label"),
  ...
  Jl.addEventListener("submit", (t) => {
    ...
    console.log(
      "Designed and Developed by Abhishek Jha. This website is copyrighted, any act of stealing or altering would result in legal action."
    );
})();
(function (o, d, l) {
  try {
